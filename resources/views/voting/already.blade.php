...
<body class="bg-gray-100">
    ...
    <div class="min-h-[80vh] flex items-center justify-center px-4">
        ...
        <!-- Tombol Kembali -->
        <div>
            <a href="/welcome" class="inline-flex items-center justify-center w-full sm:w-auto bg-gray-800 hover:bg-gray-900 text-white font-bold py-3 px-6 rounded-lg transition-all duration-300 transform hover:scale-105">
